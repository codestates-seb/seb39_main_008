...
public class CustomAuthorityUtils {
    ...
    private final List<String> ADMIN_ROLES_STRING = List.of("ROLE_ADMIN", "ROLE_MEMBER");
    private final List<String> USER_ROLES_STRING = List.of("ROLE_MEMBER");
    public List<GrantedAuthority> createAuthorities(Member.Role email) {
